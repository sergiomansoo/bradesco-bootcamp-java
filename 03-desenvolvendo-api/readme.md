...
Infraestrutura: Railway (Cloud Deployment).
...
Certifique-se de possuir o JDK compatível instalado.

Execute o projeto via IDE ou através do terminal com mvn spring-boot:run.
